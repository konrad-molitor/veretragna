...
<p>¡Hola!</p>
<p>Hemos recibido una solicitud para restablecer la contraseña de tu cuenta en Veretragna. Puedes usar el siguiente código para restablecer tu contraseña:</p>

<div style="text-align: center; margin: 30px 0;">
    <div style="font-size: 24px; letter-spacing: 4px; font-weight: bold; padding: 15px; background-color: #f3f4f6; border-radius: 4px;"><%= it.resetCode %></div>
</div>

<p>O simplemente haz clic en el botón de abajo para establecer una nueva contraseña:</p>
...
<p><strong>Nota:</strong> Este enlace y código caducarán en 1 hora.</p>
